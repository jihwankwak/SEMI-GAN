...
noise_val_iterator = torch.utils.data.DataLoader(noise_val_dataset_loader, batch_size=1, shuffle=False, **kwargs)
...
if args.mode == 'train':
    mean_result, mean_total = t_classifier.mean_sample(mean_best_model, Y_train_mean, Y_train_std, mean_val_iterator)
else:
