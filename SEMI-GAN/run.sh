...
python3 main_gan.py --date "20200909" --dataset "2020_LER_20200804_V006.xlsx" --data_type "n" --trainer 'gan' --mean_model_type 'mlp' --gan_model_type 'gan2' --pdrop 0.5 --sample_num 150
python3 main_gan.py --date "20200909" --dataset "2020_LER_20200804_V006.xlsx" --data_type "n" --trainer 'gan' --mean_model_type 'mlp' --gan_model_type 'gan2' --pdrop 0.5 --sample_num 500
python3 main_gan.py --date "20200909" --dataset "2020_LER_20200804_V006.xlsx" --data_type "n" --trainer 'gan' --mean_model_type 'mlp' --gan_model_type 'gan2' --pdrop 0.8 --sample_num 50
python3 main_gan.py --date "20200909" --dataset "2020_LER_20200804_V006.xlsx" --data_type "n" --trainer 'gan' --mean_model_type 'mlp' --gan_model_type 'gan2' --pdrop 0.8 --sample_num 150
python3 main_gan.py --date "20200909" --dataset "2020_LER_20200804_V006.xlsx" --data_type "n" --trainer 'gan' --mean_model_type 'mlp' --gan_model_type 'gan2' --pdrop 0.8 --sample_num 500
